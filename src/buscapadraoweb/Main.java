...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        crw.getListaRecursos().add("https://casadosdados.com.br/solucao/cep/sc/camboriu/centro/");
        ArrayList<String> listaCodigos = crw.carregarRecursos();

        String codigoHTML = listaCodigos.get(0);

        //mapa do alfabeto
        char[] alfabeto = new char[17];
        alfabeto[0] = '0';
        alfabeto[1] = '1';
        alfabeto[2] = '2';
        alfabeto[3] = '3';
        ...
        //tabela de transição de AFD para reconhecimento números de Rua com 4 dígitos
        int[][] matriz = new int[9][17];
        //transições de q0
